...
### /src/main/java/com/example/learnspringsecurity/HelloWorldResource.java
...
### /src/main/java/com/example/learnspringsecurity/LearnSpringSecurityApplication.java
...
### /src/test/java/com/example/learnspringsecurity/LearnSpringSecurityApplicationTests.java
...
### /src/main/java/com/example/learnspringsecurity/HelloWorldResource.java Modified
New Lines
```
...
### /src/main/java/com/example/learnspringsecurity/HelloWorldResource.java Moved to
### /src/main/java/com/example/learnspringsecurity/resources/HelloWorldResource.java New

---

### /src/main/java/com/example/learnspringsecurity/resources/TodoResource.java New
...
public class TodoResource {
	...
	private static final List<Todo> TODOS_LIST = 
			List.of(new Todo("example", "Learn AWS"),
					new Todo("example", "Get AWS Certified"));
...
### /src/main/java/com/example/learnspringsecurity/basic/BasicAuthSecurityConfiguration.java New
...
### /src/main/java/com/example/learnspringsecurity/resources/SpringSecurityPlayResource.java New
...
### /src/main/java/com/example/learnspringsecurity/basic/BasicAuthSecurityConfiguration.java Modified
...
### /src/main/java/com/example/learnspringsecurity/jwt/JwtSecurityConfiguration.java New
...
### /src/main/java/com/example/learnspringsecurity/jwt/JwtAuthenticationResource.java New
...
### /src/main/java/com/example/learnspringsecurity/jwt/JwtAuthenticationResource.java Modified
...
### /src/main/java/com/example/learnspringsecurity/jwt/JwtSecurityConfiguration.java Modified
Disable JwtSecurityConfiguration
```
//@Configuration
```

### /src/main/java/com/example/learnspringsecurity/resources/TodoResource.java Modified
New Lines
```
...
import jakarta.annotation.security.RolesAllowed;
	...
	@PostAuthorize("returnObject.username == 'example'")
