...
### /src/main/java/com/example/springboot/web/SpringBootFirstWebApplication.java
...
### /src/main/java/com/example/springboot/web/login/AuthenticationService.java

```java
package com.example.springboot.web.login;
...
public class AuthenticationService {
	public boolean authenticateUser(String user, String password) {
		boolean isValidUser = user.equalsIgnoreCase("example");
...
### /src/main/java/com/example/springboot/web/login/LoginController.java
...
### /src/main/java/com/example/springboot/web/sayhello/SayHelloController.java

```java
package com.example.springboot.web.sayhello;
...
### /src/main/java/com/example/springboot/web/todo/Todo.java

```java
package com.example.springboot.web.todo;
...
### /src/main/java/com/example/springboot/web/todo/TodoController.java
...
### /src/main/java/com/example/springboot/web/todo/TodoService.java
...
### /src/test/java/com/example/springboot/web/SpringBootFirstWebApplicationTests.java
