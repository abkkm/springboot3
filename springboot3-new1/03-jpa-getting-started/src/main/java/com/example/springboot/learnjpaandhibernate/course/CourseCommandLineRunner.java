...
//	private CourseJpaRepository repository;
	...
	public void run(String... args) throws Exception {
		repository.save(new Course(1, "Learn AWS Jpa!", "example"));
		repository.save(new Course(2, "Learn Azure Jpa!", "example"));
		repository.save(new Course(3, "Learn DevOps Jpa!", "example"));
		...
		System.out.println(repository.findByAuthor("example"));
